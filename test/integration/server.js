...
describe('Wallet service', function() {
  ...
  describe('#createWallet', function() {
    ...
    describe('Address derivation strategy', function() {
      ...
      it('should use BIP44 & P2WPKH for 1-of-1 wallet if supported', function(done) {
        var walletOpts = {
          name: 'my wallet',
          m: 1,
          n: 1,
    ...
    beforeEach(function(done) {
      helpers.createAndJoinWallet(1, 1, function(s, w) {
        ...
        helpers.stubUtxos(server, wallet, [1, 2], function() {
          var txOpts = {
            outputs: [{
              toAddress: 'dgbt1qhl05c4vcw8fcqww4dqjlk0zjwx39p2ythtk8z2',
              amount: 0.1e8,
            }],
            feePerKb: 100e2,
          };
  ...
  describe('#createAddress', function() {
    ...
    describe('shared wallets (BIP45)', function() {
      ...
      it('should create address', function(done) {
        server.createAddress({}, function(err, address) {
          ...
          address.address.should.equal('dgb1qu25s8fnsacgymkahepgyzrrxag897esy804wpddaq4k7r9lnpy6qn90waq');
    ...
    describe('shared wallets (BIP44)', function() {
      ...
      it('should create address ', function(done) {
        server.createAddress({}, function(err, address) {
          ...
          address.walletId.should.equal(wallet.id);
          address.network.should.equal('livenet');
          address.address.should.equal('dgb1qkd6s5glh488rlumk9p62v8752fkdq037hc54vp6ggmhqjyqz655sdvxtg9');
          address.isChange.should.be.false;
    ...
    describe('1-of-1 (BIP44 & P2WPKH)', function() {
      beforeEach(function(done) {
        helpers.createAndJoinWallet(1, 1, function(s, w) {
          server = s;
          wallet = w;
          w.copayers[0].id.should.equal(TestData.copayers[0].id44dgb);
          done();
        });
      });
      ...
      it('should create address', function(done) {
        server.createAddress({}, function(err, address) {
          ...
          address.walletId.should.equal(wallet.id);
          address.network.should.equal('livenet');
          address.address.should.equal('dgb1q6rawc3a7h53tw952v2vv8dxn6lwgfl3qlxrsv2');
          address.isChange.should.be.false;
          address.path.should.equal('m/0/0');
  ...
  describe('Multiple request Pub Keys', function() {
    ...
    beforeEach(function() {
      reqPrivKey = new digibyte.PrivateKey();
      ...
      var copayerId = Model.Copayer._xPubToCopayerId('dgb', TestData.copayers[0].xPubKey_44H_0H_0H);
      opts = {
        copayerId: copayerId,
    ...
    describe('#addAccess 1-1', function() {
      ...
      it('should fail to access with wrong privkey after gaining access', function(done) {
        ws.addAccess(opts, function(err, res) {
          ...
          server.getBalance(res.wallet.walletId, function(err, bal) {
            should.not.exist(err);
            var privKey = new digibyte.PrivateKey();
  ...
  describe('#getFeeLevels', function() {
    ...
    it('should get monotonically decreasing fee values', function(done) {
      _.find(Defaults.FEE_LEVELS['dgb'], {
        nbBlocks: 6
  ...
  var addrMap = {
    dgb: 'dgbt1qhl05c4vcw8fcqww4dqjlk0zjwx39p2ythtk8z2'
  }
  ...
  _.each(['dgb'], function(coin) {
    ...
    describe('#createTx ' + coin, function() {
      ...
      describe('Tx proposal creation & publishing ' + coin, function() {
        ...
        it('should fail gracefully when bitcore throws exception on raw tx creation', function(done) {
          helpers.stubUtxos(server, wallet, 1,  function() {
            var bitcoreStub = sinon.stub(digibyte, 'Transaction');
            bitcoreStub.throws({
              name: 'dummy',
        ...
        it('should accept a tx proposal signed with a custom key', function(done) {
          var reqPrivKey = new digibyte.PrivateKey();
    ...
    describe('UTXO Selection', function() {
      ...
      it('should select unconfirmed utxos if not enough confirmed utxos', function(done) {
        helpers.stubUtxos(server, wallet, ['u 1dgb', '0.5dgb'], function() {
          var txOpts = {
            outputs: [{
              toAddress: 'dgbt1qhl05c4vcw8fcqww4dqjlk0zjwx39p2ythtk8z2',
              amount: 0.8e8,
  ...
  describe('Single-address wallet', function() {
    ...
    it('should reuse address as change address on tx proposal creation', function(done) {
      helpers.stubUtxos(server, wallet, 2, function() {
        var toAddress = 'dgbt1qhl05c4vcw8fcqww4dqjlk0zjwx39p2ythtk8z2';
        var opts = {
          outputs: [{
            amount: 1e8,
            toAddress: toAddress,
  ...
  describe('#getTxHistory', function() {
    ...
    it('should get tx history with accepted proposal', function(done) {
      server._normalizeTxHistory = sinon.stub().returnsArg(0);
      var external = 'dgbt1qhl05c4vcw8fcqww4dqjlk0zjwx39p2ythtk8z2';
...
//console.log('[server.js.7149]',HugeTxs[1].vin); //TODO
  ...
  describe('#scan', function() {
    ...
    describe('1-of-1 wallet (BIP44 & P2PKH)', function() {
      ...
      it('index cache: should use cache, if previous scan failed', function(done) {
        ...
        var addr = 'dgb1q6rawc3a7h53tw952v2vv8dxn6lwgfl3qlxrsv2'; // m/0/3
  ...
  describe('#getWalletFromIdentifier', function() {
    ...
    it('should get wallet from tx proposal', function(done) {
      helpers.stubUtxos(server, wallet, '1 dgb', function() {
        helpers.stubBroadcast();
        var txOpts = {
          outputs: [{
            toAddress: 'dgbt1qhl05c4vcw8fcqww4dqjlk0zjwx39p2ythtk8z2',
  ...
  describe('BTC & BCH wallets with same seed', function() {
    ...
    it('should create address', function(done) {
      server.dgb.createAddress({}, function(err, address) {
        should.not.exist(err);
        should.exist(address);
        address.walletId.should.equal(wallet.dgb.id);
        address.network.should.equal('livenet');
        ...
        server.bch.createAddress({}, function(err, address) {
          ...
          server.dgb.getMainAddresses({}, function(err, addresses) {
            should.not.exist(err);
            addresses.length.should.equal(1);
            addresses[0].walletId.should.equal(wallet.dgb.id);
